(function() { // IIFE (Immediately Invoked Function Expression) to prevent global scope pollution
    ...
    // Default values provided for a full set of icons
    ...
    const chatbotStyles = `
        ...
        #chatbot-root-container #send-button i {
            ...
            /* Ensure Font Awesome specific properties are applied to override client's CSS */
            font-family: "Font Awesome 6 Free" !important;
            font-weight: 900 !important; /* Solid icons often use 900, adjust for brands/regular */
        }
        ...
        #chatbot-root-container .bot-message p {
            ...
            white-space: normal !important; /* Ensure paragraphs wrap */
        }
        ...
        #chatbot-root-container .bot-message ol li {
            display: flex !important; /* Use flex for list items for proper alignment of marker and text */
            align-items: flex-start !important; /* Align marker and text to the top */
            margin-bottom: 5px !important;
            line-height: 1.4 !important;
        }
        /* Styling for <p> tags directly inside <li> elements */
        ...
        #chatbot-root-container .bot-message ol li::before {
            content: "✅" !important;
            margin-right: 8px !important;
            flex-shrink: 0 !important; /* Prevent marker from shrinking */
            line-height: inherit !important;
        ...
        #chatbot-root-container .bot-message strong {
            ...
            white-space: normal !important; /* Ensure strong text wraps */
            word-break: break-word !important;
        }
