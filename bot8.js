(function() { // IIFE (Immediately Invoked Function Expression) to prevent global scope pollution
    ...
    const chatbotStyles = `
        ...
        /* Font Awesome icons within buttons */
        ...
        #chatbot-root-container #send-button i {
            ...
            font-weight: 900 !important; /* Most solid FA icons use 900 */
        }
        ...
        #chatbot-root-container .bot-message * {
            ...
            box-shadow: none !important; /* Ensure no box-shadow on inner elements */
            text-shadow: none !important; /* Ensure no text-shadow on inner elements */
            -webkit-text-stroke: 0 !important; /* Ensure no text-stroke on inner elements */
        }
        ...
        #chatbot-root-container .bot-message ol li {
            display: list-item !important; /* IMPORTANT: Changed from list-item to flex for alignment with custom marker */
            align-items: flex-start !important;
            margin-bottom: 5px !important;
            line-height: 1.4 !important;
        }
        ...
        #chatbot-root-container .bot-message ol li p {
            flex-grow: 1 !important; /* Allow paragraph to take up remaining space */
        ...
        #chatbot-root-container .bot-message ol li::before {
            ...
            display: inline-block !important; /* Ensure ::before is treated as an inline block for layout */
            vertical-align: top !important; /* Align to the top of the line box */
        }
    ...
    // Icons are now rendered using <i> tags with Font Awesome classes.
    const chatbotHTML = `
